            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                <div className="md:col-span-1 flex flex-col items-center md:sticky md:top-24">
                    <img
                        ...
                        onError={(e) => { e.target.onerror = null; e.target.src = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Crect width='100' height='100' fill='%23cccccc'/%3E%3Ctext x='50' y='50' font-size='10' fill='%23ffffff' text-anchor='middle' dy='.3em'%3ENo Image%3C/text%3E%3Csvg%3E"; }}
                    />
                    ...
                    <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow w-full mt-4">
                        <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-stone-100">
                            <CreditCard className="mr-2 text-blue-600 dark:text-blue-400"/> {content.personalInfoTitle}
                        </h3>
                        <ul className="text-gray-700 dark:text-stone-200 space-y-2">
                            {content.dob && (
                                <li className="flex items-center gap-2">
                                    <Cake className="flex-shrink-0" size={16} /> {content.dobLabel} {content.dob}
                                </li>
                            )}
                            {content.driversLicense && (
                                <li className="flex items-center gap-2">
                                    <Car className="flex-shrink-0" size={16} /> {content.driversLicenseLabel} {content.driversLicense}
                                </li>
                            )}
                            {content.nationality && (
                                <li className="flex items-center gap-2">
                                    <Globe className="flex-shrink-0" size={16} /> {content.nationalityLabel} {content.nationality}
                                </li>
                            )}
                        </ul>
                    </div>
                ...
                <div className="md:col-span-2 space-y-8">
                    <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-stone-100">
                             <UserRound className="mr-2 text-blue-600 dark:text-blue-400"/> {content.aboutMeIntroTitle}
                        </h3>
                    ...
                    <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-stone-100">
                            <Star className="mr-2 text-blue-600 dark:text-blue-400"/> {content.professionalInterestsTitle}
                        </h3>
                    ...
                    <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-stone-100">
                            <Wrench className="mr-2 text-blue-600 dark:text-blue-400"/> {content.personalSkillsTitle}
                        </h3>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow">
                         <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-stone-100">
                            <Languages className="mr-2 text-blue-600 dark:text-blue-400"/> {content.languagesTitle}
                         </h3>
                        <ul className="list-disc list-inside text-gray-700 dark:text-stone-200">
                             {content.languagesList.map((langItem, index) => (<li key={index}>{langItem}</li>))}
                         </ul>
                    </div>

                     <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow">
                          <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-stone-100">
                            <GraduationCap className="mr-2 text-blue-600 dark:text-blue-400"/> {content.educationTitle}
                          </h3>
                     ...
                     <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-4 flex items-center text-gray-900 dark:text-stone-100">
                            <Briefcase className="mr-2 text-blue-600 dark:text-blue-400"/> {content.experienceTitle}
                        </h3>
                    ...
                    <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-stone-100">
                            <Briefcase className="mr-2 text-blue-600 dark:text-blue-400"/> {content.dentistDutiesTitle}
                        </h3>
                    ...
                    <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-stone-100">
                            <Briefcase className="mr-2 text-blue-600 dark:text-blue-400"/> {content.dispensingOpticianDutiesTitle}
                        </h3>
                        <ul className="list-disc list-inside text-gray-700 dark:text-stone-200 space-y-1">
                     ...
                     <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow">
                          <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-stone-100">
                            <GraduationCap className="mr-2 text-blue-600 dark:text-blue-400"/> {content.conferencesTitle}
                          </h3>
                         <ul className="list-disc list-inside text-gray-700 dark:text-stone-200 space-y-1">
                    ...
                    <div className="p-4 md:p-6 bg-white dark:bg-blue-900 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-stone-100">
                            <GraduationCap className="mr-2 text-blue-600 dark:text-blue-400"/> {content.articlesTitle}
                        </h3>
                        <ul className="list-disc list-inside text-gray-700 dark:text-stone-200 space-y-1">
